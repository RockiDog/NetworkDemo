...
#include <jni.h>
/* Header for class com_rockidog_networkdemo_utils_Detector */

#ifndef _Included_com_rockidog_networkdemo_utils_Detector
#define _Included_com_rockidog_networkdemo_utils_Detector
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_rockidog_networkdemo_utils_Detector
 * Method:    nativeCreate
